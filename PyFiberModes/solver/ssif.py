...
class NeffSolver(FiberSolver):
    ...
    def get_TE_field(self, nu, neff: float, radius: float) -> numpy.ndarray:
        ...
        .. math::
            ...
            H_z    &= \frac{Y0 * U}{k_0 r_{core}} * j_0(U * r/r_{core}) / j_1(U) \\
            E_\phi &= -j_1(U * r/r_{core}) / j_1(U) \\
            H_r &= n_{eff} * Y0 * E_\phi \\
        ...
        .. math::
            ...
            H_z    &= \frac{Y0 * W}{k_0 r_{core}} * k_0(W * r/r_{core}) / k_1(U) \\
    ...
    def get_TM_field(self, nu, neff: float, radius: float) -> tuple:
        ...
        .. math::
            ...
            H_\phi &= Y0 * \frac{n_{core}}{n_{clad}} * k_1(W * r/r_{core}) / k_1(W) \\
